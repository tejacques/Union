...
namespace Functional.Union
{
    ...
    public class RefUnion<RUImpl, T1, T2, T3, T4>
        where RUImpl : RefUnion<RUImpl, T1, T2, T3, T4>, new()
    {
        #region Fields
        ...
        /// </summary>
        protected Union<T1, T2, T3, T4> union;
        #endregion
        ...
        /// </summary>
        protected Union<T1, T2, T3, T4>.UnionTypes Tag
        {
        ...
        /// <returns>A new union</returns>
        public static RUImpl Create(Union<T1, T2, T3, T4> union)
        {
