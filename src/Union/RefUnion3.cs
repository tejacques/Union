...
namespace Functional.Union
{
    ...
    public class RefUnion<RUImpl, T1, T2, T3>
        where RUImpl : RefUnion<RUImpl, T1, T2, T3>, new()
    {
        #region Fields
        ...
        /// <returns>A new union</returns>
        public static RUImpl Create(Union<T1, T2, T3> union)
        {
        ...
        /// <param name="Match3">The action for the thid type</param>
        /// <param name="Else">
